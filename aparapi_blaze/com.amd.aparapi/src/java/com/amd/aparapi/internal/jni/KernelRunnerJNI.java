...
public abstract class KernelRunnerJNI {
	...
	protected native int runKernelJNI(long _jniContextHandle, Range _range, boolean _needSync,
	                                  int _passes);
	...
	protected native int runExternalKernelJNI(long _jniContextHandle, Range _range,
