...
public class InstructionHelper {
	...
	public static String getLabel(Instruction instruction, boolean showNumber, boolean showExpressions,
		...
		if (!showExpressions) {
			...
			if (!verboseBytecodeLabels)
				...
				if (instruction instanceof ConditionalBranch16) {
					...
					final LocalVariableTableIndexAccessor localVariableAccessor = (LocalVariableTableIndexAccessor)
					    instruction;
