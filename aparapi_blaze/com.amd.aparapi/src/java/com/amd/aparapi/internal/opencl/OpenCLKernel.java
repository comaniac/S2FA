...
public class OpenCLKernel extends OpenCLJNI {
	 ...
	 * @param _args
	 */
	public OpenCLKernel(long kernel, OpenCLProgram programInstance, String name,
	 ...
	 * @return
	 */
	public static OpenCLKernel createKernel(OpenCLProgram _program, String _kernelName,
