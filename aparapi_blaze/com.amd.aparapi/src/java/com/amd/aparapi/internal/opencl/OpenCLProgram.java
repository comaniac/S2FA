...
public class OpenCLProgram extends OpenCLJNI {
	 ...
	 * @param _source
	 */
	public OpenCLProgram(long _programId, long _queueId, long _contextId, OpenCLDevice _device,
	                     String _source) {
	...
	public synchronized void remapped(Object _instance, long _address, OpenCLMem _mem,
	                                  long _oldAddress) {
