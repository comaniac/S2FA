...
public class Range extends RangeJNI {
	...
	public static final int MAX_GROUP_SIZE = Math.max(Runtime.getRuntime().availableProcessors() *
	    THREADS_PER_CORE,
	...
	public static Range create(Device _device, int _globalWidth, int _localWidth) {
		...
		range.setValid((range.getLocalSize_0() > 0) &&
		               (range.getLocalSize_0() <= range.getMaxWorkItemSize()[0])
		               && (range.getLocalSize_0() <= range.getMaxWorkGroupSize()) &&
	...
	public static Range create(Device _device, int _globalWidth) {
		...
		if (withoutLocal.isValid()) {
			...
			final int[] factors = getFactors(withoutLocal.getGlobalSize_0(),
			                                 withoutLocal.getMaxWorkItemSize()[0]);
	 ...
	 * @return
	 */
	public static Range create2D(Device _device, int _globalWidth, int _globalHeight, int _localWidth,
	                             int _localHeight) {
	...
	public static Range create2D(Device _device, int _globalWidth, int _globalHeight) {
		...
		if (withoutLocal.isValid()) {
			...
			withoutLocal.setValid((withoutLocal.getLocalSize_0() > 0) && (withoutLocal.getLocalSize_1() > 0)
			                      ...
			                      && ((withoutLocal.getLocalSize_0() * withoutLocal.getLocalSize_1()) <=
			                          withoutLocal.getMaxWorkGroupSize())
			                      && ((withoutLocal.getGlobalSize_0() % withoutLocal.getLocalSize_0()) == 0)
	...
	public static Range create2D(int _globalWidth, int _globalHeight, int _localWidth,
	                             int _localHeight) {
	...
	public static Range create3D(Device _device, int _globalWidth, int _globalHeight, int _globalDepth,
		...
		range.setValid((range.getLocalSize_0() > 0) && (range.getLocalSize_1() > 0) &&
		               (range.getLocalSize_2() > 0)
		               && ((range.getLocalSize_0() * range.getLocalSize_1() * range.getLocalSize_2()) <=
		                   range.getMaxWorkGroupSize())
		               && (range.getLocalSize_0() <= range.getMaxWorkItemSize()[0])
		               && (range.getLocalSize_1() <= range.getMaxWorkItemSize()[1])
	 ...
	 * @return
	 */
	public static Range create3D(Device _device, int _globalWidth, int _globalHeight,
	                             int _globalDepth) {
		...
		if (withoutLocal.isValid()) {
			...
			withoutLocal.setValid((withoutLocal.getLocalSize_0() > 0)
			                      ...
			                      && ((withoutLocal.getLocalSize_0() * withoutLocal.getLocalSize_1() * withoutLocal.getLocalSize_2())
			                          <= withoutLocal
	...
	public static Range create3D(int _globalWidth, int _globalHeight, int _globalDepth, int _localWidth,
	                             int _localHeight,
	                             int _localDepth) {
		final Range range = create3D(null, _globalWidth, _globalHeight, _globalDepth, _localWidth,
	...
	@Override public String toString() {
		...
		switch (dims) {
			case 1:
				...
				break;
			case 2:
				sb.append("2D(global:" + globalSize_0 + "x" + globalSize_1 + " local:" +
				          (localIsDerived ? "(derived)" : "")
	...
	public int getNumGroups(int _dim) {
		return (_dim == 0 ? (globalSize_0 / localSize_0) : (_dim == 1 ? (globalSize_1 / localSize_1) :
		        (globalSize_2 / localSize_2)));
	}
