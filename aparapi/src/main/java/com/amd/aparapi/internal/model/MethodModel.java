...
public abstract class MethodModel {
    ...
    private final Map<String, String> referencedFieldNames = new
    ...
    */
    ...
    public void checkForRecursion(Set<MethodModel> transitiveCalledMethods) throws
        AparapiException {
    ...
    public void setRequiredPragmas(Instruction instruction) {
        ...
        if ((instruction instanceof I_BASTORE)
                || (instruction instanceof
                    I_CASTORE /* || instruction instanceof I_SASTORE */)) {
            usesByteWrites = true;
            if (usesByteWrites && logger.isLoggable(Level.FINE))
                logger.fine("Found Byte Addressable Store on =" + instruction + " in " +
                            getName());
        }
    ...
    class ObjectRefGetReplace implements BytecodeReplacement {
        ...
        public List<Instruction> replace(List<Instruction> insns) {
            ...
            String firstGetDesc =
                firstGet.getConstantPoolFieldEntry().getNameAndTypeEntry().getDescriptorUTF8Entry()
                .getUTF8();
            String secondFieldName =
                secondGet.getConstantPoolFieldEntry().getNameAndTypeEntry().getNameUTF8Entry()
                .getUTF8();

            if (firstGetDesc.equals("Lscala/runtime/ObjectRef;") &&
                    secondFieldName.equals("elem")) {
    ...
    public Map<Integer, Instruction> createListOfInstructions() throws
        ClassParseException {
    ...
    public Map<Integer, Instruction> createListOfInstructions(
        Boolean check) throws ClassParseException {
        final Map<Integer, Instruction> pcMap = new
        LinkedHashMap<Integer, Instruction>();
        ...
        while (codeReader.hasMore()) {
            ...
            final Instruction instruction = InstructionSet.ByteCode.create(this,
                                            codeReader);

            if ((check) && (!Config.enablePUTFIELD) &&
                    (instruction instanceof I_PUTFIELD)) {
            ...
            if ((check) && (!Config.enableARETURN) && (instruction instanceof I_ARETURN))
                throw new ClassParseException(instruction,
                                              ClassParseException.TYPE.ARRAY_RETURN);

            if ((check) && (!Config.enablePUTSTATIC) &&
                    (instruction instanceof I_PUTSTATIC))
                throw new ClassParseException(instruction, ClassParseException.TYPE.PUTFIELD);

            if ((check) && (!Config.enableGETSTATIC) &&
                    (instruction instanceof I_GETSTATIC))
            ...
            if ((check) && (!Config.enableMONITOR)
                    && ((instruction instanceof I_MONITORENTER) ||
                        (instruction instanceof I_MONITOREXIT)))
                throw new ClassParseException(instruction,
                                              ClassParseException.TYPE.SYNCHRONIZE);
            ...
            if ((check) && (!Config.enableSWITCH)
                    && ((instruction instanceof I_LOOKUPSWITCH) ||
            ...
            if ((check) && !Config.enableMETHODARRAYPASSING) {
                if (instruction instanceof MethodCall) {
                    ...
                    final MethodReferenceEntry methodReferenceEntry =
                    ...
                    if (!Kernel.isMappedMethod(
                        ...
                        for (final Arg arg : methodReferenceEntry.getArgs()) {
                            if (arg.isArray())
                                throw new ClassParseException(instruction,
                                                              ClassParseException.TYPE.METHODARRAYARG);
                        }
                    }
                }
            }
        ...
        while (curr != null) {
            ...
            for (BytecodeReplacement r : replacers) {
                ...
                for (int i = 0; i < r.size() &&
                        search != null; i++, search = search.getNextPC()) {
    ...
    public void buildBranchGraphs(Map<Integer, Instruction> pcMap) {
        for (Instruction instruction = pcHead; instruction != null;
                instruction = instruction.getNextPC()) {
    ...
    public void txFormDups(ExpressionList _expressionList,
        ...
        if (_instruction instanceof I_DUP) {
            ...
            if (logger.isLoggable(Level.FINE))
                logger.fine("Found DUP_X2 prev=" + e.getPrevExpr() + " e=" + e + " curr=" +
                            _instruction);
            ...
            if (logger.isLoggable(Level.FINE))
                logger.fine("DUP_X2 insert: prev=" + e.getPrevExpr() + " e=" + e + " clone=" +
                            clone1);
            ...
            throw new ClassParseException(_instruction,
                                          ClassParseException.TYPE.UNSUPPORTEDBYTECODE);
    ...
    new InstructionTransformer("constructor merger") {
        @Override
        public Instruction transform(final ExpressionList _expressionList,
                                     final Instruction i) {
        ...
        public Instruction transform(final ExpressionList _expressionList,
            ...
            if (Config.enablePUTFIELD &&
                ...
                final AssignToInstanceField assign = (AssignToInstanceField)
                                                     i.getNextExpr().getReal();
            ...
            if (Config.enablePUTFIELD &&
                ...
                if (topLhs instanceof AccessInstanceField) {
                    ...
                    if (topRhs instanceof I_ICONST_1) {
                        if (topLhsAccess.getConstantPoolFieldIndex() ==
                                assign.getConstantPoolFieldIndex()) {
        ...
        public Instruction transform(ExpressionList _expressionList, Instruction i) {
            ...
            if ((result = InstructionPattern.accessLocalVariable.matches(i,
                ...
                if (access.getLocalVariableTableIndex() ==
                        assign.getLocalVariableTableIndex()) {
                    final IncrementInstruction inc = new IncrementInstruction(MethodModel.this,
                            (Instruction) access, true, false);
        ...
        public Instruction transform(ExpressionList _expressionList, Instruction i) {
            ...
            if ((result = InstructionPattern.longHandIncLocalVariable.matches(i,
                ...
                if (access.getLocalVariableTableIndex() ==
                    ...
                    _expressionList.replaceInclusive((Instruction) assign, (Instruction) access,
                                                     inc);
                    return (inc);
                }
        ...
        public Instruction transform(ExpressionList _expressionList, Instruction i) {
            ...
            if ((result = InstructionPattern.accessLocalVariable.matches(i,
                ...
                final AccessLocalVariable access = (AccessLocalVariable) i;
                if (access.getLocalVariableTableIndex() !=
                        0) { // we don;t want to trap on 'this' references ;)
                    final AssignToLocalVariable assign = (AssignToLocalVariable) i.getNextExpr();
                    if (access.getLocalVariableTableIndex() !=
                            assign.getLocalVariableTableIndex()) {
        ...
        public Instruction transform(ExpressionList _expressionList, Instruction i) {
            ...
            InstructionMatch result = null;
            if ((result = InstructionPattern.inc.matches(i,
                          InstructionPattern.accessLocalVariable)).ok) {
        ...
        public Instruction transform(ExpressionList _expressionList, Instruction i) {
            ...
            InstructionMatch result = null;
            if ((result = InstructionPattern.cast.matches(i,
                          InstructionPattern.assignToLocalVariable)).ok) {
                ...
                final InlineAssignInstruction inlineAssign = new InlineAssignInstruction(
                    MethodModel.this,
                    assign, cast);
                _expressionList.replaceInclusive((Instruction) cast, (Instruction) assign,
                                                 inlineAssign);
                return (inlineAssign);
        ...
        public Instruction transform(ExpressionList _expressionList, Instruction i) {
            ...
            if ((result = InstructionPattern.fieldArrayElementPlusOne.matches(i,
                ...
                final AssignToArrayElement assignArray = (AssignToArrayElement)
                        assignArrayRaw.getReal();
        ...
        public Instruction transform(ExpressionList _expressionList, Instruction i) {
            ...
            if ((result = InstructionPattern.fieldArrayElementAccess.matches(i,
                ...
                final Instruction assignArrayRaw = i.getNextExpr();
                final AccessArrayElement accessArray = (AccessArrayElement)
                                                       accessArrayRaw.getReal();
                final AssignToArrayElement assignArray = (AssignToArrayElement)
                        assignArrayRaw.getReal();
                final AccessField accessField1 = (AccessField)
                                                 accessArray.getArrayRef().getReal();
                final AccessField accessField2 = (AccessField)
                                                 assignArray.getArrayRef().getReal();
                if (accessField1.getConstantPoolFieldIndex() ==
                        accessField2.getConstantPoolFieldIndex()) {
        ...
        public Instruction transform(ExpressionList _expressionList, Instruction i) {
            ...
            if ((result = InstructionPattern.methodCall.matches(i,
                ...
                final FieldArrayElementAssign inlineAssign = new FieldArrayElementAssign(
                    MethodModel.this,
                    assign, invoke);
    ...
    void applyTransformations(ExpressionList _expressionList,
                              final Instruction _instruction,
                              final Instruction _operandStart) throws ClassParseException {

        if (logger.isLoggable(Level.FINE)) {
            System.err.println("We are looking at " + _instruction +
                               " which wants to consume "
                               + _instruction.getStackConsumeCount() + " operands, produces stack? "
                               + _operandStart.producesStack() + ", is assign to local? "
                               + (_instruction instanceof AssignToLocalVariable) +
                               ", next is assign to local? "
        ...
        if ((_instruction instanceof AssignToLocalVariable) &&
            ...
            if (assign == null) {
                final Instruction newOne = new MultiAssignInstruction(this, _operandStart,
                        assignFirst, assign);
        ...
        if (!txformed) {
            boolean again = false;
            for (Instruction i = _operandStart; i != null;
        ...
        if (txformed) {
            if (logger.isLoggable(Level.FINE)) {
                ...
                System.out.println("We are looking at " + _instruction +
                                   " which wants to consume "
     ...
     */
    void checkForGetter(Map<Integer, Instruction> pcMap,
                        ClassModel owner) throws ClassParseException {
        ...
        if (mightBeGetter) {
            ...
            if ((rawVarNameCandidate != null) && (isNoCL() ||
                                                  possiblySimpleGetImplementation)) {
                ...
                if (!isNoCL()) {
                    ...
                    if ((instruction instanceof Return) &&
                            (expressionList.getHead() == expressionList.getTail())) {
                        instruction = instruction.getPrevPC();
                        if (instruction instanceof AccessInstanceField) {
                            final FieldEntry field = ((AccessInstanceField)
                                                      instruction).getConstantPoolFieldEntry();
                        ...
                        throw new ClassParseException(ClassParseException.TYPE.BADGETTERNAMENOTFOUND,
                                                      methodName);
                } else {
     ...
     */
    void checkForSetter(Map<Integer, Instruction> pcMap) throws
        ClassParseException {
        final String methodName = getMethod().getName();
        if (methodName.startsWith("set")) {
            ...
            if ((instruction instanceof AssignToInstanceField) &&
                    (expressionList.getTail() instanceof Return)
                    && (pcMap.size() == 4)) {
                final Instruction prev = instruction.getPrevPC();
                if (prev instanceof AccessLocalVariable) {
                    final FieldEntry field = ((AssignToInstanceField)
                                              instruction).getConstantPoolFieldEntry();
                    accessedFieldName = field.getNameAndTypeEntry().getNameUTF8Entry().getUTF8();
                    if (accessedFieldName.equals(varNameCandidateCamelCased)) {
                        ...
                        if (fieldType.equals(setterArgType)) {
                            ...
                            throw new ClassParseException(ClassParseException.TYPE.BADSETTERTYPEMISMATCH,
                                                          methodName);
                    } else
                        throw new ClassParseException(ClassParseException.TYPE.BADSETTERTYPEMISMATCH,
                                                      methodName);
    ...
    public static class FakeLocalVariableTableEntry implements
        ...
        class Var implements LocalVariableInfo {
            ...
            public boolean equals(Object object) {
                return (object instanceof Var && ((object == this) ||
                                                  ((Var) object).name.equals(name)));
            }
        ...
        public FakeLocalVariableTableEntry(Map<Integer, Instruction> _pcMap,
                                           ClassModelMethod _method) {
            int numberOfSlots = _method.getCodeEntry().getMaxLocals();

            MethodDescription description = ClassModel.getMethodDescription(
            ...
            for (int i = 0; i < args.length; i++) {
                ...
                vars[i + thisOffset] = new Var(argsAsStoreSpecs[i + thisOffset], i + thisOffset,
                                               0, true);
            ...
            if (Config.enableShowFakeLocalVariableTable) {
                ...
                for (LocalVariableInfo lvi : list) {
                    Var var = (Var) lvi;
                    System.out.println(String.format(" %5d   %5d  %4d  %8s     %s", var.startPc,
                                                     var.getLength(),
    ...
    protected void initWithoutAnalysis(ClassModelMethod _method) throws
        AparapiException {
        method = _method;
    ...
    protected void init(ClassModelMethod _method) throws AparapiException {
        ...
        final int exceptionsSize =
            method.getCodeEntry().getExceptionPoolEntries().size();
        if (exceptionsSize > 0) {
            if (logger.isLoggable(Level.FINE))
        ...
        if (isNoCL() || (entrypoint != null) &&
                (_method.getClassModel() != entrypoint.getClassModel())) {
            if (logger.isLoggable(Level.FINE))
    ...
    public LocalVariableTableEntry<LocalVariableInfo> getLocalVariableTableEntry() {
        return ((LocalVariableTableEntry<LocalVariableInfo>)
                method.getLocalVariableTableEntry());
    }
    ...
    public String getName() {
        return (method.getClassModel().getMethod(method.getName(),
                method.getDescriptor()).getClassModel()
