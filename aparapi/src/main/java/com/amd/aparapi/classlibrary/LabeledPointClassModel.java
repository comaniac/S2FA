...
public class LabeledPointClassModel extends CustomizedClassModel {
    ...
    public LabeledPointClassModel() {
        ...
        addField(new CustomizedFieldModel("features",
                                          "org.apache.spark.mllib.linalg.Vector", 1));

        CustomizedMethodModel<?> getLabelMethod =
            new CustomizedMethodModel<LabeledPointClassModel>(
        this, "label", METHODTYPE.GETTER) {
            ...
            public Map<String, String> getArgs(
                LabeledPointClassModel clazzModel) {
                return null;
            }
        ...
        CustomizedMethodModel<?> getFeatureMethod =
            new CustomizedMethodModel<LabeledPointClassModel>(
