    ...
    public DenseVectorClassModel() {
        ...
        /*
                CustomizedMethodModel<?> get_initMethod =
                    new CustomizedMethodModel<DenseVectorClassModel>(
                    ...
                    public Map<String, String> getArgs(
                        DenseVectorClassModel clazzModel) {
        ...
        */
        CustomizedMethodModel<?> getSizeMethod =
            new CustomizedMethodModel<DenseVectorClassModel>(
        ...
        this, "apply", METHODTYPE.GETTER) {
            ...
            @Override
            public String getBody(DenseVectorClassModel clazzModel) {
                return "return " + getFieldModel("values")
                       .genArrayElementAccess("index") + ";";
            }
        };
